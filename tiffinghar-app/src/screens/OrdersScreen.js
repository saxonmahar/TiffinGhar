        ...
        <View style={s.list}>
          {loading ? (
            ...
            <View style={s.empty}>
              ...
              <Text style={s.emptySub}>{lang === 'ne' ? 'होम पेजबाट अर्डर गर्नुस्' : 'Place an order from Home'}</Text>
            </View>
          ) : (
            displayed.map(o => <OrderCard key={o._id || o.id} order={o} onUpdate={fetchOrders} />)
          )}
        </View>
      </ScrollView>
    </SafeAreaView>
